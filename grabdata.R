...
#install_github("eshiz33/BSE4304/BSEHyrdoModels")
...
#USGS 01645704 DIFFICULT RUN ABOVE FOX LAKE NEAR FAIRFAX, VA
...
summary(modeldata)
summary()# Save your functions and build up your working "modeldata" dataframe
